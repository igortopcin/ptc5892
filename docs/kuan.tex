...
\hat{f}(i,j)=\bar{f}(i,j)+\frac{v_{f}(i,j)}{v_{f}(i,j)+\frac{\sigma_{u}^{2}}{E(u)}[(\bar{f}(i,j))^{2}+v_{f}(i,j)]}(g(i,j)-\bar{f}(i,j))
\end{eqnarray}
...
Sendo assim, podemos reescrever \ref{eq:llmmsemult_v} substituindo $\frac{\sigma_{u}^{2}}{E(u)}$ por $C_u$:
...
w(i,j)=\frac{v_{f}(i,j)}{v_{f}(i,j)+C_u[(\bar{f}(i,j))^{2}+v_{f}(i,j)]}
=\frac{v_{f}(i,j)}{v_{f}(i,j)+C_u(\bar{g}(i,j))^{2}+C_uv_{f}(i,j)} \nonumber \\
=[\frac{\sigma_{g}^{2}(i,j)-C_u(\bar{g}(i,j))^{2}}{1+C_u}] . [\frac{1}{\frac{\sigma_{g}^{2}(i,j)-C_u(\bar{g}(i,j))^{2}}{1+C_u}(1+C_u)+C_u(\bar{g}(i,j))^{2}}] \nonumber\\
=[\frac{\sigma_{g}^{2}(i,j)-C_u(\bar{g}(i,j))^{2}}{1+C_u}] . [\frac{1}{\sigma_{g}^{2}(i,j)-C_u(\bar{g}(i,j))^{2}+C_u(\bar{g}(i,j))^{2}}] \nonumber \\
=\frac{\sigma_{g}^{2}(i,j)-C_u(\bar{g}(i,j))^{2}}{(1+C_u)\sigma_{g}^{2}(i,j)} \nonumber
=\frac{\sigma_{g}^{2}(i,j)}{(1+C_u)\sigma_{g}^{2}(i,j)} - \frac{C_u(\bar{g}(i,j))^{2}}{(1+C_u)\sigma_{g}^{2}(i,j)} \nonumber \\
=\frac{1}{1+C_u} - \frac{C_u(\frac{\bar{g}(i,j)}{\sigma_{g}})^{2}}{1+C_u} \nonumber \\
=\frac{1 - C_u(\frac{\bar{g}(i,j)}{\sigma_{g}})^{2}}{1+C_u}
\end{eqnarray}

Fazendo $C_i(i,j)=\frac{\sigma_x(i,j)}{\bar{g}(i,j))}$ e substituindo em \ref{eq:llmmsemult_w2}, temos:
